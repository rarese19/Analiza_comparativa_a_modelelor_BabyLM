...
vocab = set()
with open("evaluation_pipeline/ewok/vocab.txt", 'r', encoding='utf-8') as vocabfile:
...
for domain in items_per_domain.keys():
    with open(f"evaluation_data/full_eval/ewok_filtered/{domain}.jsonl", 'w', encoding='utf-8') as outfile:
