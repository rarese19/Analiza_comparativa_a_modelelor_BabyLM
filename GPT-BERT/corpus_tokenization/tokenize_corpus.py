...
def parse_args():
    ...
    parser.add_argument("--train_file", type=Path, default="babylm_original_data_unigram_train.jsonl")
    parser.add_argument("--valid_file", type=Path, default="babylm_original_data_unigram_validation.jsonl")
    parser.add_argument("--tokenizer_folder", type=Path, default="../tokenizers/")
    parser.add_argument("--tokenizer_file", type=Path, default="tokenizer_unigram_original_data_10M.json")
