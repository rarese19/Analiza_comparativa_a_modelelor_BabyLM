...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default="../data/babylm_original_data.jsonl", help='Specify the input filename')
    parser.add_argument('--validation_path', type=str, default="../data/babylm_original_data.jsonl", help='Specify the validation filename')
    parser.add_argument('--vocab_path', type=str, default="../tokenizers/tokenizer_unigram_original_data_10M.json", help='Specify the output filename')
    parser.add_argument('--vocab_size', type=int, default=2**13, help='Number of subwords in the trained tokenizer')
