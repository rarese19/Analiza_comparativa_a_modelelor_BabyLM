...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=Path, default="../data/babylm_original_data.jsonl", help='Specify the input filename')
    parser.add_argument('--validation_path', type=Path, default="../data/babylm_original_data.jsonl", help='Specify the validation filename')
    parser.add_argument('--vocab_path', type=Path, default="../tokenizers/tokenizer_original_data10M.json", help='Specify the output filename')
